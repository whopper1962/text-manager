...
export class Migration1693982924676 implements MigrationInterface {
    name = 'Migration1693982924676'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "last_name" character varying NOT NULL, "first_name" character varying NOT NULL, "password" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "updated_at" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "tags" ADD CONSTRAINT "FK_7ab852bb0ada09a0fc3adb7e5de" FOREIGN KEY ("project_id") REFERENCES "projects"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "text_tags" ADD CONSTRAINT "FK_0c4390323123037a07aec51e96f" FOREIGN KEY ("text_master_id") REFERENCES "text_masters"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "text_masters" ADD CONSTRAINT "FK_bff1ff0633aee04485cb4664854" FOREIGN KEY ("project_id") REFERENCES "projects"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "text_contents" ADD CONSTRAINT "FK_6d77cce3eb6761263c89c5bf201" FOREIGN KEY ("text_master_id") REFERENCES "text_masters"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "text_contents" ADD CONSTRAINT "FK_82ad31e1947ddf058c37062aa00" FOREIGN KEY ("language_id") REFERENCES "languages"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "languages" ADD CONSTRAINT "FK_df927a65a54f70a73645f151dcb" FOREIGN KEY ("project_id") REFERENCES "projects"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "languages" DROP CONSTRAINT "FK_df927a65a54f70a73645f151dcb"`);
        await queryRunner.query(`ALTER TABLE "text_contents" DROP CONSTRAINT "FK_82ad31e1947ddf058c37062aa00"`);
        await queryRunner.query(`ALTER TABLE "text_contents" DROP CONSTRAINT "FK_6d77cce3eb6761263c89c5bf201"`);
        await queryRunner.query(`ALTER TABLE "text_masters" DROP CONSTRAINT "FK_bff1ff0633aee04485cb4664854"`);
        await queryRunner.query(`ALTER TABLE "text_tags" DROP CONSTRAINT "FK_4b51e9a877a92ff57fdbde55c6f"`);
        await queryRunner.query(`ALTER TABLE "text_tags" DROP CONSTRAINT "FK_0c4390323123037a07aec51e96f"`);
