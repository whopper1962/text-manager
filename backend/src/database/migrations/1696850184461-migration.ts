...
export class Migration1696850184461 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "bookmarks" ADD CONSTRAINT "FK_d49e031f6a7321f5c3befaa5bfa" FOREIGN KEY ("project_member_id") REFERENCES "project_members"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
